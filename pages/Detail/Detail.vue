        ...
        <view class="tui-draw">
          ...
          <view class="tui-search">
            <uni-easyinput
              ...
              :styles="styles"
              primaryColor="#822151"
              placeholderStyle="color:#c9c9c9;font-size:28rpx"
            ></uni-easyinput>
          </view>
          <view class="">
            <v-tabs
          ...
          <view class="tui-variety">
            ...
            <view class="tui-varietyContent">
              ...
              >
                ...
                <view class="tui-rightVariety" style="flex: 1">
                  <view class="code"> 1.08484 </view>
                  <view style="justify-content: flex-end" class="flex">
                    <view class="tui-end"> +0.16% </view>
                  </view>
                </view>
              </view>
            </view>
...
<script>
import { goodDetail, goodKline } from "@/api/detail.js";
export default {
  components: {
  ...
  methods: {
    getDetail() {
      const { id, codename } = this.options;
      goodDetail({
        id,
        hideLoading: true,
      }).then(({ data }) => {
